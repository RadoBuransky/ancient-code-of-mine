...
begin
  ...
  Faktury.SpolocnyText.Assign( Memo1.Lines );
end;
...
begin
  ZapisText( 'text1.txt' , Memo1 );
  ZapisText( 'text2.txt' , Memo2 );
  ZapisText( 'text3.txt' , Memo3 );
...
begin
  ...
  Faktury.SpolocnyText.Assign( Memo.Lines );
