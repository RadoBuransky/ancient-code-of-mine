...
begin
  ...
  //NaËÌtanie hlaviËky a popisu jednotliv˝ch polÌ (Field descriptors)
  ...
  if Koniec <> $0D then
    begin
      MessageDlg( 'Nebol n·jden˝ koniec hlaviËky!' , mtError , [mbOK] , 0 );
      FileStr.Free;
      Exit;
    end;
