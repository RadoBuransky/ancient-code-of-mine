...
<body>
  ...
  <div align="center">
    ...
    <table width=500 cellspacing=0 cellpadding=0 border=0>
	  ...
	  <tr bgcolor=#ffcfa5>
	    <td></td>
	    <td colspan=2><font face="verdana" color="#660000"><strong>meno</strong></font></td>
		<td colspan=2><input name="meno" type="text" value="" size=49 align="right"></td>
		<td></td>	    
	  </tr>
	  <tr bgcolor=#ffcfa5>
	    <td></td>
	    <td colspan=2><font face="verdana" color="#660000"><strong>heslo</strong></font></td>
		<td colspan=2><input name="heslo" type="password" value="" size=49 align="right"></td>
		<td></td>
	  </tr>
	  <tr bgcolor=#ffcfa5>
