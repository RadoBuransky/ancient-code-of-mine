...
<tr>
  <td colspan=3>
    <table width=700 height=20 cellpadding=0 cellspacing=0 border=0>
	  <tr>
	    <td width=10><img src="../admin/images/l.gif" width="10" height="20" alt="" border="0"></td>
		<td bgcolor=#ffe5e5>		      
		  <MARQUEE STYLE="height: 20px; border: 0pt solid; width: 680px" DIRECTION="Left">
		    <b><? echo( MySQL_Result( $Result , $i , 0 ) ); ?></b>
		  </marquee>
		</td>
		<td width=10><img src="../admin/images/r.gif" width="10" height="20" alt="" border="0"></td>
	  </tr>
	</table>
  </td>
</tr>
